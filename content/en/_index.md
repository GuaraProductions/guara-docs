...
This site was created to centralize the best guides, tools, and libraries for developers using the Godot Engine. Browse the sections below to find the ideal material for your project, from initial logic to final sound design.

---

## 🚀 Where to start?

If you are new to the field, we recommend following this learning path:

1.  **Fundamentals:** Understand programming logic and the structure of computing.
2.  **The Engine:** Explore the Godot interface and the Nodes and Scenes system.
3.  **Assets:** Learn how to choose and import models, sprites, and sounds in the correct formats.
